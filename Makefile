...
clean:
	...
	rm -rf build dist extractnet/*.pyc extractnet/*.so extractnet/lcs.cpp extractnet/blocks.cpp extractnet.egg-info extractnet/features/*.pyc extractnet/features/*.so extractnet/features/*.cpp
